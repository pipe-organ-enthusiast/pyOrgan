...
class StopEditor(QFrame):
    ...
    def __init_ui_rank_harmonic_adsr_settings(self) -> None:
        ...
        # Harmonic ADSR Group
        self.__rank_harmonics_adsr: QGroupBox = QGroupBox("Harmonic ADSR Settings - Rank")
    ...
    def __init_ui_pipe_harmonic_adsr_settings(self) -> None:
        ...
        # Harmonic ADSR Group
        self.__pipe_harmonics_adsr: QGroupBox = QGroupBox("Harmonic ADSR Settings - Pipe")
        ic(self.__pipe_harmonics_adsr)
        # Attack
    ...
    def __ui_layout_stop_settings(self) -> None:
        ...
        self.__stop_settings.setLayout(stop_settings_layout)
        ic(self.__stop_settings.layout())
    ...
    def __ui_layout_rank_harmonic(self) -> None:
        ...
        rank_harmonic_layout.addWidget(self.__ui_layout_rank_harmonics_widget())
